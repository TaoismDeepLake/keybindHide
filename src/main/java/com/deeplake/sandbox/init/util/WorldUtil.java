...
public class WorldUtil {
    ...
    public static NBTTagCompound getDimNbtIDL(World world)
    {
        ...
        if (worldNBT != null)
        {
            NBTTagCompound idlNBT = worldNBT.getCompoundTag(ExampleMod.MODID);
            if (idlNBT == null)
            {
                idlNBT = new NBTTagCompound();
                worldNBT.setTag(ExampleMod.MODID, idlNBT);
            ...
            ExampleMod.LogWarning("nbt is null");
            return new NBTTagCompound();
        }
    }
    ...
    public static void saveDimData(World world)
    {
        ...
        nbt.setTag(ExampleMod.MODID, nbtIDL);
